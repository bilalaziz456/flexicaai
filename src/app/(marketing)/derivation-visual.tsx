      ...
      <div className="rounded-2xl bg-card/70 p-5 ring-1 ring-primary/20 backdrop-blur">
        ...
        <div className="mt-4 flex items-start gap-3">
          ...
          <span className="min-w-0">
            <span className="block text-sm font-medium">Visit completed</span>
        ...
        <div className="relative mt-3 pl-4">
          ...
          >
            <span className="text-xs text-muted-foreground">Net for the visit</span>
            <span className="font-mono text-lg font-medium text-primary-text tabular-nums">
              7,930
            </span>
          </div>
        </div>

        <p className="mt-5 flex items-start gap-2.5 border-t border-foreground/10 pt-4 text-xs leading-snug text-muted-foreground">
          <BadgeCheck className="mt-px size-4 shrink-0 text-primary-text" />
          <span>
