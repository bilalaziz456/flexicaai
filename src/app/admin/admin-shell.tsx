...
/**
 * Super Admin panel chrome: a left sidebar on desktop (logo + icon/text nav +
 * sign out with label) and a top bar with a hamburger drawer on mobile (sign
 * out is icon-only). Mirrors ClinicShell; the server layout passes in the
 * signed-in username + saved theme.
 */
