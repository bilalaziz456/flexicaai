...
| 2026-07-10 | **Date as a dropdown in the appointment form.** Replaced the native `<input type="date">` with a `<select>` of upcoming dates (next ~90 days) labelled "Mon, 13 Jul 2026" — day + date, matching the doctor/time dropdown UI. Value stays "YYYY-MM-DD"; past dates aren't listed. |
